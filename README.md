# BiGRU-GCN-Anomaly-Detection
Hybrid approach combining bidirectional GRU (BiGRU) and Graph Convolutional Networks (GCN) for real-time anomaly detection in dynamic computer network data.
